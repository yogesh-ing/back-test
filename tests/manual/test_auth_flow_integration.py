...
from backtest.brokers.session_manager import BrokerSessionManager, get_session_manager, reset_default_manager
from backtest.brokers.base import BrokerAuthBase, STATUS_AUTHENTICATED, STATUS_UNAUTHENTICATED
...
class TestFullAuthenticationFlow:
    ...
    def test_step3_verify_totp_completes_authentication(self, client, stub):
        ...
        login_resp = client.post('/api/broker/login', json={
            'username': 'test_user',
            'password': 'test_password'
        })
        ...
        # Then verify TOTP
        totp_resp = client.post('/api/broker/verify-totp', json={
            'totp_code': '123456'
        })
    ...
    def test_complete_flow_all_steps(self, client, stub):
        ...
        login = client.post('/api/broker/login', json={
            'username': 'test_user',
            'password': 'test_password'
        })
        ...
        # Step 3: Verify TOTP
        totp = client.post('/api/broker/verify-totp', json={
            'totp_code': '123456'
        })
