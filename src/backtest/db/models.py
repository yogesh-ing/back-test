...
class Position(Base):
    ...
    portfolio_id: Mapped[str] = mapped_column(
        UUIDStr, ForeignKey("portfolios.portfolio_id", ondelete="CASCADE", name="fk_positions_portfolio"), nullable=False
    )
    symbol: Mapped[str] = mapped_column(String(64), nullable=False)
    exchange: Mapped[str] = mapped_column(String(16), nullable=False, server_default=text("'NSE'"))
    position_type: Mapped[str] = mapped_column(String(8), nullable=False, server_default=text("'long'"))
    ...
    commission_total: Mapped[Decimal] = mapped_column(Money, nullable=False, server_default=text("0"))
...
class Order(Base):
    ...
    portfolio_id: Mapped[str] = mapped_column(
        UUIDStr, ForeignKey("portfolios.portfolio_id", ondelete="CASCADE", name="fk_orders_portfolio"), nullable=False
    )
    ...
    filled_quantity: Mapped[Decimal] = mapped_column(Price, nullable=False, server_default=text("0"))
    ...
    time_in_force: Mapped[str] = mapped_column(String(8), nullable=False, server_default=text("'day'"))
...
class Fill(Base):
    ...
    order_id: Mapped[str] = mapped_column(
        UUIDStr, ForeignKey("orders.order_id", ondelete="CASCADE", name="fk_fills_order"), nullable=False
    )
    position_id: Mapped[Optional[str]] = mapped_column(
    ...
    slippage_amount: Mapped[Decimal] = mapped_column(Money, nullable=False, server_default=text("0"))
    exchange_fees: Mapped[Decimal] = mapped_column(Money, nullable=False, server_default=text("0"))
    regulatory_fees: Mapped[Decimal] = mapped_column(Money, nullable=False, server_default=text("0"))
    ...
    __table_args__ = (
        ...
        CheckConstraint(
            "liquidity_flag IS NULL OR liquidity_flag IN ('maker','taker')", name="ck_fills_liquidity"
        ),
    ...
    def total_fees(self) -> Decimal:
        ...
        return Decimal(self.commission) + Decimal(self.exchange_fees) + Decimal(self.regulatory_fees)
...
class Trade(Base):
    ...
    portfolio_id: Mapped[str] = mapped_column(
        UUIDStr, ForeignKey("portfolios.portfolio_id", ondelete="CASCADE", name="fk_trades_portfolio"), nullable=False
    )
    position_id: Mapped[Optional[str]] = mapped_column(
...
class EquityCurve(Base):
    ...
    portfolio_id: Mapped[str] = mapped_column(
        UUIDStr, ForeignKey("portfolios.portfolio_id", ondelete="CASCADE", name="fk_equity_portfolio"), nullable=False
    )
...
class MarketDataCache(Base):
    ...
    __table_args__ = (
        ...
        CheckConstraint("open > 0 AND high > 0 AND low > 0 AND close > 0", name="ck_mdc_prices_pos"),
...
class PerformanceMetric(Base):
    ...
    portfolio_id: Mapped[str] = mapped_column(
        UUIDStr, ForeignKey("portfolios.portfolio_id", ondelete="CASCADE", name="fk_perf_portfolio"), nullable=False
    )
    ...
    total_commission: Mapped[Decimal] = mapped_column(Money, nullable=False, server_default=text("0"))
    ...
    __table_args__ = (
        ...
        CheckConstraint("win_rate IS NULL OR (win_rate >= 0 AND win_rate <= 1)", name="ck_perf_win_rate"),
...
class StrategySignal(Base):
    ...
    portfolio_id: Mapped[str] = mapped_column(
        UUIDStr, ForeignKey("portfolios.portfolio_id", ondelete="CASCADE", name="fk_signals_portfolio"), nullable=False
    )
    symbol: Mapped[str] = mapped_column(String(64), nullable=False)
    strategy_name: Mapped[Optional[str]] = mapped_column(String(64))
    ...
    __table_args__ = (
        ...
        CheckConstraint("strength IS NULL OR (strength >= 0 AND strength <= 1)", name="ck_signals_strength"),
        CheckConstraint(
    ...
    def __repr__(self) -> str:  # pragma: no cover
        return f"<Signal {self.symbol} {self.signal_type}/{self.direction} executed={self.executed}>"
...
class SystemLog(Base):
    ...
    portfolio_id: Mapped[Optional[str]] = mapped_column(
        UUIDStr, ForeignKey("portfolios.portfolio_id", ondelete="SET NULL", name="fk_logs_portfolio")
    )
